...
## 4. Отдельная задача для Pexels-видео
...
Pexels, накладывает оформление и публикует его с заметкой. Если Pexels или
рендеринг недоступны, используется анимированная картинка новости, затем фото
или текст. Общая блокировка не позволяет обычной и видеозадаче публиковаться
одновременно, а общая история защищает от повторов.
